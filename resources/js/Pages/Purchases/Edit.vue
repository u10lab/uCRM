                    ...
                    <section class="text-gray-600 body-font relative">
                        <form @submit.prevent="updatePurchase(form.id)">
                            <div class="container px-5 py-8 mx-auto">
                                <div class="lg:w-2/3 md:w mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="date" class="leading-7 text-sm text-gray-600">日付</label>
                                                <input disabled type="date" id="date" :value="form.date" name="date"
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">                                
                                              <label for="customer"
                                                ...
                                                <input disabled type="text" id="customer" :value="props.order[0].customer_name" name="date"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        <div class="lg:w mt-8 w-full mx-auto overflow-auto">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">                                
                                              <label for="status"
                                                ...
                                                <input type="radio" id="status" v-model="form.status" name="status" value="1">未キャンセル</input>
                                                <input type="radio" id="status" v-model="form.status" name="status" value="0">キャンセルする</input>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <button
